...
Recorded in `SECURITY_INVARIANTS.md` as **SEC-INV-123** (historically SEC-INV-039; renumbered on forward-port because current main already assigns SEC-INV-039 … SEC-INV-042 to server-side adapter routing).
