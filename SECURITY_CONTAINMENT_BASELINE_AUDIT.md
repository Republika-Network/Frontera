...
| M-6 | **AGGREGATE BEHAVIOUR IS BOUNDED, NOT ONLY PER-ACTION BEHAVIOUR.** | B, N |
...
9. "Frontera detects agent abuse or anomalous behavior." No rate limiting, no velocity, no aggregate analysis — and the authorization layers are *banned* from containing any.
